            ...
            <div class="row">
                ...
                <div class="col-12 col-sm-6 col-xl-3">
                    <div class="footer-widget mb-70">
                        <!-- Logo -->
                        <a href="/" class="foo-logo d-block mb-4"><img src="{{ asset('img/core-img/logo.png') }}" alt=""></a>
                        <!-- Footer Newsletter Area -->
                        {{-- <div class="footer-nl-area">
                            <form action="#">
                                <input type="email" name="nl-email" class="form-control" id="nlEmail" placeholder="Get udates">
                        ...
                        <div class="twitter-slides owl-carousel">
                            ...
                            <div class="single--twitter-slide">
                                ...
                                <div class="single-twit">
                                    <p><i class="fa fa-twitter"></i> <span>@Leonard</span> Live youtubers portal coming soon. Stay Tuned.....</p>
                                </div>
                                {{-- <!-- Single Twit -->
                                <div class="single-twit">
                    ...
                    <div class="footer-widget mb-70">
                        ...
                        <div class="single-blog-post d-flex">
                            ...
                            <div class="post-content">
                                <a href="#" class="post-title">DC Shoes: gymkhana the</a>
                ...
                <div class="col-12 col-sm-6 col-xl-3">
                    <div class="footer-widget mb-70">
                        ...
                        <div class="footer-social-area">
                            <a href="https://www.facebook.com/LiveTubers-103347338823592" class="facebook" target="_blank"><i class="fa fa-facebook"></i></a>
            ...
            <div class="container">
                <div class="row align-items-center">
                    ...
                    <div class="col-12 col-sm-6">
                        ...
                        Copyright &copy;<script>document.write(new Date().getFullYear());</script> All rights reserved | Developed By: <a href="http://solarixtechnology.com" target="_blank">Solarix Technology</a>
